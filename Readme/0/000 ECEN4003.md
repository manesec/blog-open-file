...
6. 理论：`决策树 (Decision tree)`
   ...
   - [Decision Tree Algorithm | Decision Tree in Python | Machine Learning Algorithms | Edureka - Youtube](https://youtu.be/qDcl-FRnwSU?t=637) 详细的介绍决策树。
